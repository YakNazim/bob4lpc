...
#define PRESCALE0 2000000
#define PRESCALE1 100000
...
*/
char* CRAWL_string="QPortland State Aerospace SocietyR";
...
int main() {
    ...
    serial_putstring(CRAWL_string);     // store crawl
    serial_putstring(CLEAR_SCREEN);
...
//    command doesn't work?
    ...
    serial_putstring(START_CRAWL);    // start crawl
    serial_putstring(CLEAR_SCREEN);
...
void initialize(void)  {
    ...
    SET_PRESCALE0(PRESCALE0);
    SET_PRESCALE1(PRESCALE1);        
